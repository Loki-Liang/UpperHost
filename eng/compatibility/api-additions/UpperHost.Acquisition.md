...
Surface: UpperHost.Acquisition adds session-definition enrichment, default CanonicalRawBlock Raw-first ingress resolution, non-blocking raw sink capability, and a Required RawRecorder lifecycle adapter.
