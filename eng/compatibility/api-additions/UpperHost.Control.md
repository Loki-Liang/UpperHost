...
Surface: UpperHost.Control adds DeviceSnapshotStore/Observation/Quality contracts, DevicePollRuntime/PollPlan contracts, TypedParameterRuntime/comparer/codec contracts, shared ICommandResourceArbiter and device-control state/rehydrate contracts.
