...
internal static class RawRecorderTelemetry
{
    public static Counter<long> AcceptedBlocks { get; } =
        UpperHostTelemetry.Meter.CreateCounter<long>("upperhost.raw.accepted.blocks", "{block}");
    public static Counter<long> AcceptedBytes { get; } =
        UpperHostTelemetry.Meter.CreateCounter<long>("upperhost.raw.accepted.bytes", "By");
    public static Counter<long> WrittenBlocks { get; } =
        UpperHostTelemetry.Meter.CreateCounter<long>("upperhost.raw.written.blocks", "{block}");
    public static Counter<long> WrittenBytes { get; } =
        UpperHostTelemetry.Meter.CreateCounter<long>("upperhost.raw.written.bytes", "By");
    public static Counter<long> LowDiskWarnings { get; } =
        UpperHostTelemetry.Meter.CreateCounter<long>("upperhost.raw.low_disk.warning", "{warning}");
